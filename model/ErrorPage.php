...
Class ErrorPage extends Router
{
    ...
    public static function process($Errno)
    {
        ...
        switch ($Errno) {
            case 100:
                Echo "Error code: " . $Errno . " The configuration file is either missing from the root directory, or is blank please regenerate.";
                break;
            case 101:
                Echo "Error code: " . $Errno . " Unable to connect to the database, please check your database connection settings.";
                break;
            case 102:
                Echo "Error code: " . $Errno . " the default table does not exist, please run setup.";
                break;
            case 103:
                Echo "Error code: " . $Errno . " Unable to connect to the database, please check your database connection settings.";
                break;
            case 105:
                Echo "Error code: " . $Errno . " Unable to load the Javascript file, please check log and that this exists and try again.";
                break;
            case 106:
                Echo "Error code: " . $Errno . " Unable to load the CSS file, please check log and that this exists and try again.";
                break;
            case 107:
                Echo "Error code: " . $Errno . "The specified table does not exist, please recheck the details or " . "<a href='index.php?url=Installation'>Click here to run set up</a>";
                break;
            default:
